  ...
  return (
    <div id="about" className="">
      <p className="text-gray-400 text-[14px] leading-6">
        I’m a <span className="text-white px-1">full-stack</span> developer
      ...
      <p className="text-gray-400 text-[14px] leading-6 mt-4">
        ...
        contributing to{" "}
        <span className="text-white px-1">multiple projects</span> and exploring
        new technologies across frontend and backend engineering. I’ve gained
        hands-on experience integrating{" "}
        <span className="text-white px-1">AI models like LLaMA</span>,
        implementing
        <span className="text-white px-1">auto KYC verification systems</span>,
        and working on the company’s flagship platform,{" "}
        <span className="text-white px-1">CoinSpe.com</span>, a crypto-based
      ...
      <p className="text-gray-400 text-[14px] leading-6 mt-4">
        ...
        <span className="text-white px-1">Veew</span>, a virtual event hosting
